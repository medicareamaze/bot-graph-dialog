...
class ConditionHandler {
  ...
  static evaluateExpression(object, expression) {
    // changes to ensure Conditions can contain variables. object is actually session.dialogData.data passed from NAvigator.js
    expression = strformat(expression, object);
