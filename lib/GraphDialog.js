...
class GraphDialog {
  ...
  generateAdaptiveCardMessage(session, node) {
    ...
    // var strNodeContent = JSON.stringify(node.data.content);
    // strNodeContent = strformat(strNodeContent,session.dialogData.data);
    // var nodeContent = JSON.parse(strNodeContent);
